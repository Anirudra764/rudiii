  ...
  return (
    <div className="relative animate-in fade-in duration-500 text-white">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Cinematic Crimson dust overlay */}
        <div className="absolute inset-0 bg-radial-at-t from-[#E32636]/15 via-transparent to-transparent pointer-events-none z-10" />
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl space-y-6 animate-in slide-in-from-bottom-12 duration-1000">
          ...
          <span className="text-xs uppercase tracking-[0.45em] text-[#E32636] font-mono font-bold block animate-pulse text-center">
            {activeSettings.tagline}
          </span>

          <motion.h1 
            className="text-6xl md:text-9xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-100 to-[#E32636] leading-none select-none text-center uppercase font-display cursor-default relative drop-shadow-[0_4px_30px_rgba(227,38,54,0.35)]"
          ...
          >
            ...
            >
              ...
              <div className="absolute -inset-1.5 bg-gradient-to-r from-[#E32636] via-[#FF4D4D] to-[#8B0000] rounded-xl blur-lg opacity-40 group-hover:opacity-85 transition duration-500 group-hover:duration-200 animate-pulse" />
              
              <button
                onClick={onExploreTourEvents}
                className="relative px-8 py-4 rounded-xl bg-gradient-to-r from-[#E32636] to-[#8B0000] hover:from-[#FF4D4D] hover:to-[#E32636] text-white font-mono text-xs uppercase tracking-[0.25em] font-extrabold flex items-center gap-3.5 transition-all duration-300 shadow-2xl group/btn cursor-pointer"
              >
                <Ticket className="w-4 h-4 text-white group-hover/btn:rotate-12 transition-transform duration-300" />
                <span className="relative z-10">{activeSettings.homeHeroButton1}</span>
                <ChevronRight className="w-4 h-4 text-white group-hover/btn:translate-x-1.5 transition-transform duration-300" />
              </button>
            </motion.div>
            ...
            >
              ...
              >
                <Compass className="w-4 h-4 text-[#E32636] group-hover/btn2:rotate-45 transition-transform duration-500" />
                <span>{activeSettings.homeHeroButton3}</span>
                <Sparkles className="w-3.5 h-3.5 text-[#FF4D4D] opacity-0 group-hover/btn2:opacity-100 group-hover/btn2:scale-110 transition-all duration-300" />
              </button>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          <div className="mt-2.5 relative w-[18px] h-[30px] rounded-full border border-zinc-500/20 flex justify-center p-1 bg-black/40 backdrop-blur-md shadow-[0_0_12px_rgba(255,255,255,0.02)]">
            ...
            <motion.div 
              className="w-1 h-2 rounded-full bg-[#E32636] shadow-[0_0_6px_rgba(227,38,54,0.8)]"
              animate={{ 
                y: [0, 10, 0],
                opacity: [1, 0.3, 1]
              }}
          ...
          <motion.div 
            className="w-[1px] bg-gradient-to-b from-[#E32636]/80 to-transparent mt-2.5"
            animate={{ 
              height: [0, 16, 0],
              opacity: [0, 0.8, 0]
            }}
      ...
      <div className="relative py-24 bg-gradient-to-b from-[#0b0a11] via-[#100c1d] to-[#05040a] z-20 border-t border-white/[0.03] overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-[#E32636]/15 via-[#8B0000]/10 to-transparent rounded-full filter blur-[120px] pointer-events-none" />
        <div className="absolute -top-10 left-10 w-96 h-96 bg-[#E32636]/5 rounded-full filter blur-[90px] pointer-events-none" />
        
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          {/* Subtle line decoration */}
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-[#E32636]/50" />
            <Sparkles className="w-4 h-4 text-[#E32636]" />
            <div className="h-[1px] w-12 bg-gradient-to-l from-transparent to-[#E32636]/50" />
          </div>
          ...
          >
            ...
            <span className="text-[10px] tracking-[0.45em] font-mono font-black text-[#E32636] uppercase block">
              ★ THE DYER OF SOULS ★
            </span>
            <h2 className="text-4xl md:text-6xl font-black tracking-tight text-white mb-6 uppercase">
              REVOLUTIONIZING <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E32636] to-[#8B0000]">SUFI FUSION ROCK</span>
            </h2>
          </motion.div>
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-16 md:w-24 h-full bg-gradient-to-r from-[#E32636]/15 to-transparent pointer-events-none z-10" />
            <div className="absolute top-0 right-0 w-16 md:w-24 h-full bg-gradient-to-l from-[#8B0000]/15 to-transparent pointer-events-none z-10" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
            {[
              ...
              <motion.div
                ...
                className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#E32636]/50 transition-all duration-300 relative group overflow-hidden"
              >
                ...
                <span className="text-[9px] font-mono tracking-widest text-[#E32636] uppercase block mb-1">
                  {item.subtitle}
                </span>
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-[#E32636] transition-colors">
                  {item.title}
                </h3>
      ...
      {upcomingEvent && activeSettings.areTicketsReleased && (
        <div className="py-12 bg-gradient-to-r from-[#181524] to-[#0f0e13] border-y border-[#8B0000]/20 px-6">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#E32636]/10 border border-[#E32636]/30 flex items-center justify-center text-[#E32636] flex-shrink-0 animate-pulse">
                <Calendar className="w-5 h-5" />
              </div>
              <div>
                <span className="text-[9px] font-mono uppercase text-[#E32636]">Next Live Date Scheduled</span>
            ...
            <button
              onClick={onExploreTourEvents}
              className="px-6 py-2.5 rounded-xl bg-transparent border border-[#E32636] hover:bg-[#E32636] hover:text-black font-bold text-xs uppercase transition-colors"
            >
              Order Tickets
            </button>
          </div>
